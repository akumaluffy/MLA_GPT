class ModelConfig:
    def __init__(self):
        ...
        self.n_embd = 768                   # Embed dim
        self.n_head = 8                     # Attention heads
        self.n_layer = 8                    # Transformer layers
        ...
        self.accumulation_steps = 4         # Gradient accumulation steps, memory vs. compute
        self.warmup_iters = 500             # Learning rate warmup iterations, longer for stability
        ...
        # Optimization flags
        self.gradient_checkpointing = False  # Use gradient checkpointing, crucial for large models
